...
# tsParticles DesertSand Palette
...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/earth/desertSand/images/sample.png)](https://particles.js.org/samples/palettes/desertSand)
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-desertSand@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
Checkout the documentation in the component library repository and call the `loadDesertSandPalette` function.
