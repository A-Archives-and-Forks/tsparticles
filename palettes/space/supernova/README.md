...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/space/supernova/images/sample.png)](https://particles.js.org/samples/palettes/supernova)
...
<table>
  <tbody>
    ...
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#CC0022"><rect width="32" height="32" fill="#CC0022" /></svg><br />
        <code>#CC0022</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#AA44FF"><rect width="32" height="32" fill="#AA44FF" /></svg><br />
        <code>#AA44FF</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadSupernovaPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-supernova@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadSupernovaPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadSupernovaPalette` function.
