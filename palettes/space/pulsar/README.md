...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/space/pulsar/images/sample.png)](https://particles.js.org/samples/palettes/pulsar)
...
<table>
  <tbody>
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#1133AA"><rect width="32" height="32" fill="#1133AA" /></svg><br />
        <code>#1133AA</code>
      </td>
    </tr>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#000844"><rect width="32" height="32" fill="#000844" /></svg><br />
        <code>#000844</code>
      </td>
    </tr>
    <tr>
      <td colspan="5" align="center">
        <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#000205"><rect width="40" height="40" fill="#000205" /></svg><br />
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadPulsarPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-pulsar@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadPulsarPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadPulsarPalette` function.
