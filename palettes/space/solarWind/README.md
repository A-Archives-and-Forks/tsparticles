...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/space/solarWind/images/sample.png)](https://particles.js.org/samples/palettes/solarWind)
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadSolarWindPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-solarWind@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadSolarWindPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadSolarWindPalette` function.
