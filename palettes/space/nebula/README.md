...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/space/nebula/images/sample.png)](https://particles.js.org/samples/palettes/nebula)
...
<table>
  <tbody>
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#6A0DAD"><rect width="32" height="32" fill="#6A0DAD" /></svg><br />
        <code>#6A0DAD</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#8A2BE2"><rect width="32" height="32" fill="#8A2BE2" /></svg><br />
        <code>#8A2BE2</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FF4FD8"><rect width="32" height="32" fill="#FF4FD8" /></svg><br />
        <code>#FF4FD8</code>
      </td>
    </tr>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#66CCFF"><rect width="32" height="32" fill="#66CCFF" /></svg><br />
        <code>#66CCFF</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#C792FF"><rect width="32" height="32" fill="#C792FF" /></svg><br />
        <code>#C792FF</code>
      </td>
      <td align="center">
    ...
    <tr>
      <td colspan="5" align="center">
        <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#050014"><rect width="40" height="40" fill="#050014" /></svg><br />
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-nebula@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
