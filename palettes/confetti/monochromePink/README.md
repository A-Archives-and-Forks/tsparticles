...
<table>
  <tbody>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FF99BB"><rect width="32" height="32" fill="#FF99BB" /></svg><br />
        <code>#FF99BB</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FF66AA"><rect width="32" height="32" fill="#FF66AA" /></svg><br />
        <code>#FF66AA</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FF3388"><rect width="32" height="32" fill="#FF3388" /></svg><br />
        <code>#FF3388</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#CC1166"><rect width="32" height="32" fill="#CC1166" /></svg><br />
        <code>#CC1166</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#990044"><rect width="32" height="32" fill="#990044" /></svg><br />
        <code>#990044</code>
      </td>
    </tr>
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFCCDD"><rect width="32" height="32" fill="#FFCCDD" /></svg><br />
        <code>#FFCCDD</code>
      </td>
    </tr>
    <tr>
      <td colspan="5" align="center">
        <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#fff0f5"><rect width="40" height="40" fill="#fff0f5" /></svg><br />
