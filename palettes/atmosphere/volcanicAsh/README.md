...
<table>
  <tbody>
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#555555"><rect width="32" height="32" fill="#555555" /></svg><br />
        <code>#555555</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#777777"><rect width="32" height="32" fill="#777777" /></svg><br />
        <code>#777777</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#999999"><rect width="32" height="32" fill="#999999" /></svg><br />
        <code>#999999</code>
      </td>
    </tr>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#BBBBBB"><rect width="32" height="32" fill="#BBBBBB" /></svg><br />
        <code>#BBBBBB</code>
      </td>
      <td align="center">
    ...
    <tr>
      <td colspan="5" align="center">
        <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#080808"><rect width="40" height="40" fill="#080808" /></svg><br />
