...
# tsParticles ColoredSmokeRainbow Palette
...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/atmosphere/coloredSmokeRainbow/images/sample.png)](https://particles.js.org/samples/palettes/coloredSmokeRainbow)
...
<table>
  <tbody>
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#CC6600"><rect width="32" height="32" fill="#CC6600" /></svg><br />
        <code>#CC6600</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#CCCC00"><rect width="32" height="32" fill="#CCCC00" /></svg><br />
        <code>#CCCC00</code>
      </td>
      <td align="center">
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#CC00CC"><rect width="32" height="32" fill="#CC00CC" /></svg><br />
        <code>#CC00CC</code>
      </td>
    </tr>
    <tr>
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-coloredSmokeRainbow@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
