...
# tsParticles MetalSparks Palette
...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/fire/metalSparks/images/sample.png)](https://particles.js.org/samples/palettes/metalSparks)
  ...
  <tbody>
    ...
    <tr>
      <td colspan="5" align="center">
        <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#080400"><rect width="40" height="40" fill="#080400" /></svg><br />
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-metalSparks@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
Checkout the documentation in the component library repository and call the `loadMetalSparksPalette` function.
