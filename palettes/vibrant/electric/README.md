...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/vibrant/electric/images/sample.png)](https://particles.js.org/samples/palettes/electric)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#0D0221"><rect width="32" height="32" fill="#0D0221" /></svg><br />
        <code>#0D0221</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#3D5AF1"><rect width="32" height="32" fill="#3D5AF1" /></svg><br />
        <code>#3D5AF1</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#7B2CBF"><rect width="32" height="32" fill="#7B2CBF" /></svg><br />
        <code>#7B2CBF</code>
      </td>
    </tr>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#C60C30"><rect width="32" height="32" fill="#C60C30" /></svg><br />
        <code>#C60C30</code>
      </td>
      <td align="center">
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#8338EC"><rect width="32" height="32" fill="#8338EC" /></svg><br />
        <code>#8338EC</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadElectricPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-electric@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadElectricPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadElectricPalette` function.
