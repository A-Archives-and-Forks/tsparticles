...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/vibrant/tropical/images/sample.png)](https://particles.js.org/samples/palettes/tropical)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#001A4D"><rect width="32" height="32" fill="#001A4D" /></svg><br />
        <code>#001A4D</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#00D9FF"><rect width="32" height="32" fill="#00D9FF" /></svg><br />
        <code>#00D9FF</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FF006E"><rect width="32" height="32" fill="#FF006E" /></svg><br />
        <code>#FF006E</code>
      </td>
    </tr>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFBE0B"><rect width="32" height="32" fill="#FFBE0B" /></svg><br />
        <code>#FFBE0B</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FB5607"><rect width="32" height="32" fill="#FB5607" /></svg><br />
        <code>#FB5607</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#3A86FF"><rect width="32" height="32" fill="#3A86FF" /></svg><br />
        <code>#3A86FF</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#08F7FE"><rect width="32" height="32" fill="#08F7FE" /></svg><br />
        <code>#08F7FE</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadTropicalPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-tropical@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadTropicalPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadTropicalPalette` function.
