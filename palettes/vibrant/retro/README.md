...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/vibrant/retro/images/sample.png)](https://particles.js.org/samples/palettes/retro)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#1A0A2E"><rect width="32" height="32" fill="#1A0A2E" /></svg><br />
        <code>#1A0A2E</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FF6B35"><rect width="32" height="32" fill="#FF6B35" /></svg><br />
        <code>#FF6B35</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#F7931E"><rect width="32" height="32" fill="#F7931E" /></svg><br />
        <code>#F7931E</code>
      </td>
    </tr>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FDB833"><rect width="32" height="32" fill="#FDB833" /></svg><br />
        <code>#FDB833</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#C41E3A"><rect width="32" height="32" fill="#C41E3A" /></svg><br />
        <code>#C41E3A</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#8B0000"><rect width="32" height="32" fill="#8B0000" /></svg><br />
        <code>#8B0000</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FF1744"><rect width="32" height="32" fill="#FF1744" /></svg><br />
        <code>#FF1744</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadRetroPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-retro@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
Checkout the documentation in the component library repository and call the `loadRetroPalette` function.
