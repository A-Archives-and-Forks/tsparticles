...
# tsParticles LaserScatter Palette
...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/optics/laserScatter/images/sample.png)](https://particles.js.org/samples/palettes/laserScatter)
...
<table>
  <tbody>
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFCCCC"><rect width="32" height="32" fill="#FFCCCC" /></svg><br />
        <code>#FFCCCC</code>
      </td>
    </tr>
    <tr>
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadLaserScatterPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-laserScatter@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadLaserScatterPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadLaserScatterPalette` function.
