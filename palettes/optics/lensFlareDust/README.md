...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/optics/lensFlareDust/images/sample.png)](https://particles.js.org/samples/palettes/lensFlareDust)
...
<table>
  <tbody>
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFCCBB"><rect width="32" height="32" fill="#FFCCBB" /></svg><br />
        <code>#FFCCBB</code>
      </td>
      <td align="center">
    ...
    <tr>
      <td colspan="5" align="center">
        <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#060400"><rect width="40" height="40" fill="#060400" /></svg><br />
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadLensFlareDustPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-lensFlareDust@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadLensFlareDustPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadLensFlareDustPalette` function.
