...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/optics/bokehCold/images/sample.png)](https://particles.js.org/samples/palettes/bokehCold)
...
<table>
  <tbody>
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#6688EE"><rect width="32" height="32" fill="#6688EE" /></svg><br />
        <code>#6688EE</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#4455CC"><rect width="32" height="32" fill="#4455CC" /></svg><br />
        <code>#4455CC</code>
      </td>
      <td align="center">
    ...
    <tr>
      <td colspan="5" align="center">
        <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#00010a"><rect width="40" height="40" fill="#00010a" /></svg><br />
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadBokehColdPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-bokehCold@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadBokehColdPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadBokehColdPalette` function.
