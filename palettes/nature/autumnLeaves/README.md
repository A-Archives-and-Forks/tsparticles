...
# tsParticles AutumnLeaves Palette
...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/nature/autumnLeaves/images/sample.png)](https://particles.js.org/samples/palettes/autumnLeaves)
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-autumnLeaves@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
Checkout the documentation in the component library repository and call the `loadAutumnLeavesPalette` function.
