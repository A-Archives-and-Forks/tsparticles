...
# tsParticles SpringBloom Palette
...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/nature/springBloom/images/sample.png)](https://particles.js.org/samples/palettes/springBloom)
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadSpringBloomPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-springBloom@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadSpringBloomPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadSpringBloomPalette` function.
