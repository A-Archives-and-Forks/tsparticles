...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/nature/fireflies/images/sample.png)](https://particles.js.org/samples/palettes/fireflies)
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadFirefliesPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-fireflies@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadFirefliesPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadFirefliesPalette` function.
