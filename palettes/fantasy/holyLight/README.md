...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/fantasy/holyLight/images/sample.png)](https://particles.js.org/samples/palettes/holyLight)
...
<table>
  <tbody>
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#AA6600"><rect width="32" height="32" fill="#AA6600" /></svg><br />
        <code>#AA6600</code>
      </td>
      <td align="center">
    ...
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFFFDD"><rect width="32" height="32" fill="#FFFFDD" /></svg><br />
        <code>#FFFFDD</code>
      </td>
      <td align="center">
    ...
    <tr>
      <td colspan="5" align="center">
        <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#0a0800"><rect width="40" height="40" fill="#0a0800" /></svg><br />
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-holyLight@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
Checkout the documentation in the component library repository and call the `loadHolyLightPalette` function.
