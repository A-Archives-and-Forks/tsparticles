...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/fantasy/mermaid/images/sample.png)](https://particles.js.org/samples/palettes/mermaid)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#04101A"><rect width="32" height="32" fill="#04101A" /></svg><br />
        <code>#04101A</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#B3E5FC"><rect width="32" height="32" fill="#B3E5FC" /></svg><br />
        <code>#B3E5FC</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#4DD0E1"><rect width="32" height="32" fill="#4DD0E1" /></svg><br />
        <code>#4DD0E1</code>
      </td>
    </tr>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#26A69A"><rect width="32" height="32" fill="#26A69A" /></svg><br />
        <code>#26A69A</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#00897B"><rect width="32" height="32" fill="#00897B" /></svg><br />
        <code>#00897B</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#006064"><rect width="32" height="32" fill="#006064" /></svg><br />
        <code>#006064</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadMermaidPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-mermaid@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadMermaidPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadMermaidPalette` function.
