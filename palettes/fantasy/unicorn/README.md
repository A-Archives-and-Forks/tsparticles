...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/fantasy/unicorn/images/sample.png)](https://particles.js.org/samples/palettes/unicorn)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#F0F1FF"><rect width="32" height="32" fill="#F0F1FF" /></svg><br />
        <code>#F0F1FF</code>
      </td>
      <td align="center">
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#E1BEE7"><rect width="32" height="32" fill="#E1BEE7" /></svg><br />
        <code>#E1BEE7</code>
      </td>
    </tr>
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#C8E6C9"><rect width="32" height="32" fill="#C8E6C9" /></svg><br />
        <code>#C8E6C9</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFF9C4"><rect width="32" height="32" fill="#FFF9C4" /></svg><br />
        <code>#FFF9C4</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadUnicornPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-unicorn@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadUnicornPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadUnicornPalette` function.
