...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/water/rain/images/sample.png)](https://particles.js.org/samples/palettes/rain)
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-rain@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
Checkout the documentation in the component library repository and call the `loadRainPalette` function.
