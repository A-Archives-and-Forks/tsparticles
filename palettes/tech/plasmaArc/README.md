...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/tech/plasmaArc/images/sample.png)](https://particles.js.org/samples/palettes/plasmaArc)
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadPlasmaArcPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-plasmaArc@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadPlasmaArcPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadPlasmaArcPalette` function.
