...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/tech/vaporwave/images/sample.png)](https://particles.js.org/samples/palettes/vaporwave)
...
<table>
  <tbody>
    ...
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#00BBFF"><rect width="32" height="32" fill="#00BBFF" /></svg><br />
        <code>#00BBFF</code>
      </td>
      <td align="center">
    ...
    <tr>
      <td colspan="5" align="center">
        <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#05010f"><rect width="40" height="40" fill="#05010f" /></svg><br />
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadVaporwavePalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-vaporwave@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadVaporwavePalette(engine);
...
Checkout the documentation in the component library repository and call the `loadVaporwavePalette` function.
