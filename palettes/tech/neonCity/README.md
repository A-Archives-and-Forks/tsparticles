...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/tech/neonCity/images/sample.png)](https://particles.js.org/samples/palettes/neonCity)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#00FF88"><rect width="32" height="32" fill="#00FF88" /></svg><br />
        <code>#00FF88</code>
      </td>
    </tr>
    <tr>
      <td colspan="5" align="center">
        <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#05000f"><rect width="40" height="40" fill="#05000f" /></svg><br />
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadNeonCityPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-neonCity@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadNeonCityPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadNeonCityPalette` function.
