...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/tech/hologram/images/sample.png)](https://particles.js.org/samples/palettes/hologram)
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-hologram@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
Checkout the documentation in the component library repository and call the `loadHologramPalette` function.
