...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/fireworks/blue/images/sample.png)](https://particles.js.org/samples/palettes/blue)
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadBluePalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-blue@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
Checkout the documentation in the component library repository and call the `loadBluePalette` function.
