...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/fireworks/ice/images/sample.png)](https://particles.js.org/samples/palettes/ice)
...
<table>
  <tbody>
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#E8F8FF"><rect width="32" height="32" fill="#E8F8FF" /></svg><br />
        <code>#E8F8FF</code>
      </td>
      <td align="center">
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#66BBFF"><rect width="32" height="32" fill="#66BBFF" /></svg><br />
        <code>#66BBFF</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#2299FF"><rect width="32" height="32" fill="#2299FF" /></svg><br />
        <code>#2299FF</code>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5" align="center">
        <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#010a14"><rect width="40" height="40" fill="#010a14" /></svg><br />
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadIcePalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-ice@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
Checkout the documentation in the component library repository and call the `loadIcePalette` function.
