...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/fireworks/copper/images/sample.png)](https://particles.js.org/samples/palettes/copper)
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadCopperPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-copper@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadCopperPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadCopperPalette` function.
