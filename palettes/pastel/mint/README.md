...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/pastel/mint/images/sample.png)](https://particles.js.org/samples/palettes/mint)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#F0FFF8"><rect width="32" height="32" fill="#F0FFF8" /></svg><br />
        <code>#F0FFF8</code>
      </td>
      <td align="center">
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#B3F5E8"><rect width="32" height="32" fill="#B3F5E8" /></svg><br />
        <code>#B3F5E8</code>
      </td>
    </tr>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#BAFFFF"><rect width="32" height="32" fill="#BAFFFF" /></svg><br />
        <code>#BAFFFF</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#D4FFEF"><rect width="32" height="32" fill="#D4FFEF" /></svg><br />
        <code>#D4FFEF</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#C0F0DE"><rect width="32" height="32" fill="#C0F0DE" /></svg><br />
        <code>#C0F0DE</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#CAFFCC"><rect width="32" height="32" fill="#CAFFCC" /></svg><br />
        <code>#CAFFCC</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadMintPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-mint@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
Checkout the documentation in the component library repository and call the `loadMintPalette` function.
