...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/pastel/sunset/images/sample.png)](https://particles.js.org/samples/palettes/sunset)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFF3E6"><rect width="32" height="32" fill="#FFF3E6" /></svg><br />
        <code>#FFF3E6</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFD4B3"><rect width="32" height="32" fill="#FFD4B3" /></svg><br />
        <code>#FFD4B3</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFCCBA"><rect width="32" height="32" fill="#FFCCBA" /></svg><br />
        <code>#FFCCBA</code>
      </td>
    </tr>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFD9B3"><rect width="32" height="32" fill="#FFD9B3" /></svg><br />
        <code>#FFD9B3</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFCAB3"><rect width="32" height="32" fill="#FFCAB3" /></svg><br />
        <code>#FFCAB3</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFE4BA"><rect width="32" height="32" fill="#FFE4BA" /></svg><br />
        <code>#FFE4BA</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFC9BA"><rect width="32" height="32" fill="#FFC9BA" /></svg><br />
        <code>#FFC9BA</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadSunsetPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-sunset@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadSunsetPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadSunsetPalette` function.
