...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/pastel/warm/images/sample.png)](https://particles.js.org/samples/palettes/warm)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFF5F0"><rect width="32" height="32" fill="#FFF5F0" /></svg><br />
        <code>#FFF5F0</code>
      </td>
      <td align="center">
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFE4B3"><rect width="32" height="32" fill="#FFE4B3" /></svg><br />
        <code>#FFE4B3</code>
      </td>
    </tr>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFF4BA"><rect width="32" height="32" fill="#FFF4BA" /></svg><br />
        <code>#FFF4BA</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFE5BA"><rect width="32" height="32" fill="#FFE5BA" /></svg><br />
        <code>#FFE5BA</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFD9C0"><rect width="32" height="32" fill="#FFD9C0" /></svg><br />
        <code>#FFD9C0</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFE8CC"><rect width="32" height="32" fill="#FFE8CC" /></svg><br />
        <code>#FFE8CC</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadWarmPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-warm@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
Checkout the documentation in the component library repository and call the `loadWarmPalette` function.
