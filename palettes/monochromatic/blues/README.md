...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/monochromatic/blues/images/sample.png)](https://particles.js.org/samples/palettes/blues)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#000B1E"><rect width="32" height="32" fill="#000B1E" /></svg><br />
        <code>#000B1E</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#001F3F"><rect width="32" height="32" fill="#001F3F" /></svg><br />
        <code>#001F3F</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#003B73"><rect width="32" height="32" fill="#003B73" /></svg><br />
        <code>#003B73</code>
      </td>
    </tr>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#0064B4"><rect width="32" height="32" fill="#0064B4" /></svg><br />
        <code>#0064B4</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#1A8FE3"><rect width="32" height="32" fill="#1A8FE3" /></svg><br />
        <code>#1A8FE3</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#5BB8FF"><rect width="32" height="32" fill="#5BB8FF" /></svg><br />
        <code>#5BB8FF</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#A8D8FF"><rect width="32" height="32" fill="#A8D8FF" /></svg><br />
        <code>#A8D8FF</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadBluesPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-blues@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
Checkout the documentation in the component library repository and call the `loadBluesPalette` function.
