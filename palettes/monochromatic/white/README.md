...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/monochromatic/white/images/sample.png)](https://particles.js.org/samples/palettes/white)
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadWhitePalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-white@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
Checkout the documentation in the component library repository and call the `loadWhitePalette` function.
