...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/monochromatic/noir/images/sample.png)](https://particles.js.org/samples/palettes/noir)
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadNoirPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-noir@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
Checkout the documentation in the component library repository and call the `loadNoirPalette` function.
