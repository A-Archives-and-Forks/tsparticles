...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/monochromatic/pinks/images/sample.png)](https://particles.js.org/samples/palettes/pinks)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#1A0010"><rect width="32" height="32" fill="#1A0010" /></svg><br />
        <code>#1A0010</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#3D0018"><rect width="32" height="32" fill="#3D0018" /></svg><br />
        <code>#3D0018</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#7A0030"><rect width="32" height="32" fill="#7A0030" /></svg><br />
        <code>#7A0030</code>
      </td>
    </tr>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#B50048"><rect width="32" height="32" fill="#B50048" /></svg><br />
        <code>#B50048</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#E5006A"><rect width="32" height="32" fill="#E5006A" /></svg><br />
        <code>#E5006A</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FF5599"><rect width="32" height="32" fill="#FF5599" /></svg><br />
        <code>#FF5599</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFAAD4"><rect width="32" height="32" fill="#FFAAD4" /></svg><br />
        <code>#FFAAD4</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadPinksPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-pinks@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
Checkout the documentation in the component library repository and call the `loadPinksPalette` function.
