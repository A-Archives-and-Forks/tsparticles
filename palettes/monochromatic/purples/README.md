...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/monochromatic/purples/images/sample.png)](https://particles.js.org/samples/palettes/purples)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#0D0020"><rect width="32" height="32" fill="#0D0020" /></svg><br />
        <code>#0D0020</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#1A0033"><rect width="32" height="32" fill="#1A0033" /></svg><br />
        <code>#1A0033</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#3D0080"><rect width="32" height="32" fill="#3D0080" /></svg><br />
        <code>#3D0080</code>
      </td>
    </tr>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#6600CC"><rect width="32" height="32" fill="#6600CC" /></svg><br />
        <code>#6600CC</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#9933FF"><rect width="32" height="32" fill="#9933FF" /></svg><br />
        <code>#9933FF</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#BB77FF"><rect width="32" height="32" fill="#BB77FF" /></svg><br />
        <code>#BB77FF</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#E0C2FF"><rect width="32" height="32" fill="#E0C2FF" /></svg><br />
        <code>#E0C2FF</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadPurplesPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-purples@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadPurplesPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadPurplesPalette` function.
