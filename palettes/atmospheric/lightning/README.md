...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/atmospheric/lightning/images/sample.png)](https://particles.js.org/samples/palettes/lightning)
...
<table>
  <tbody>
    ...
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#0033CC"><rect width="32" height="32" fill="#0033CC" /></svg><br />
        <code>#0033CC</code>
      </td>
      <td align="center">
    ...
    <tr>
      <td colspan="5" align="center">
        <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#000005"><rect width="40" height="40" fill="#000005" /></svg><br />
    ...
    <tr>
      <td colspan="5" align="center">
        <strong>Blend mode:</strong> <code>lighter</code> | <strong>Fill:</strong> <code>false</code>
      </td>
    </tr>
  </tbody>
</table>
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-lightning@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
Checkout the documentation in the component library repository and call the `loadLightningPalette` function.
