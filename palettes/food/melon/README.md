...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/food/melon/images/sample.png)](https://particles.js.org/samples/palettes/melon)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#08120E"><rect width="32" height="32" fill="#08120E" /></svg><br />
        <code>#08120E</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFDDA0"><rect width="32" height="32" fill="#FFDDA0" /></svg><br />
        <code>#FFDDA0</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFC473"><rect width="32" height="32" fill="#FFC473" /></svg><br />
        <code>#FFC473</code>
      </td>
    </tr>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFB74D"><rect width="32" height="32" fill="#FFB74D" /></svg><br />
        <code>#FFB74D</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadMelonPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-melon@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
Checkout the documentation in the component library repository and call the `loadMelonPalette` function.
