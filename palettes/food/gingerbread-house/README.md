...
# tsParticles GingerbreadHouse Palette
...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/food/gingerbread-house/images/sample.png)](https://particles.js.org/samples/palettes/gingerbread-house)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#1A0F07"><rect width="32" height="32" fill="#1A0F07" /></svg><br />
        <code>#1A0F07</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#A9744F"><rect width="32" height="32" fill="#A9744F" /></svg><br />
        <code>#A9744F</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#BF6E3E"><rect width="32" height="32" fill="#BF6E3E" /></svg><br />
        <code>#BF6E3E</code>
      </td>
    </tr>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#8D6E63"><rect width="32" height="32" fill="#8D6E63" /></svg><br />
        <code>#8D6E63</code>
      </td>
      <td align="center">
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#D7CCC8"><rect width="32" height="32" fill="#D7CCC8" /></svg><br />
        <code>#D7CCC8</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadGingerbreadHousePalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-gingerbread-house@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadGingerbreadHousePalette(engine);
...
Checkout the documentation in the component library repository and call the `loadGingerbreadHousePalette` function.
