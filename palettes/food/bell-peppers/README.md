...
# tsParticles BellPeppers Palette
...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/food/bell-peppers/images/sample.png)](https://particles.js.org/samples/palettes/bell-peppers)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#08110A"><rect width="32" height="32" fill="#08110A" /></svg><br />
        <code>#08110A</code>
      </td>
      <td align="center">
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FB8C00"><rect width="32" height="32" fill="#FB8C00" /></svg><br />
        <code>#FB8C00</code>
      </td>
    </tr>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FDD835"><rect width="32" height="32" fill="#FDD835" /></svg><br />
        <code>#FDD835</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#43A047"><rect width="32" height="32" fill="#43A047" /></svg><br />
        <code>#43A047</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadBellPeppersPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-bell-peppers@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadBellPeppersPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadBellPeppersPalette` function.
