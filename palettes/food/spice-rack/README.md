...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/food/spice-rack/images/sample.png)](https://particles.js.org/samples/palettes/spice-rack)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#120B07"><rect width="32" height="32" fill="#120B07" /></svg><br />
        <code>#120B07</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#F57C00"><rect width="32" height="32" fill="#F57C00" /></svg><br />
        <code>#F57C00</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadSpiceRackPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-spice-rack@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadSpiceRackPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadSpiceRackPalette` function.
