...
# tsParticles TropicalFruits Palette
...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/food/tropical-fruits/images/sample.png)](https://particles.js.org/samples/palettes/tropical-fruits)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#0B1208"><rect width="32" height="32" fill="#0B1208" /></svg><br />
        <code>#0B1208</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FF7043"><rect width="32" height="32" fill="#FF7043" /></svg><br />
        <code>#FF7043</code>
      </td>
      <td align="center">
    ...
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFEB3B"><rect width="32" height="32" fill="#FFEB3B" /></svg><br />
        <code>#FFEB3B</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#4CAF50"><rect width="32" height="32" fill="#4CAF50" /></svg><br />
        <code>#4CAF50</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#8BC34A"><rect width="32" height="32" fill="#8BC34A" /></svg><br />
        <code>#8BC34A</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#E91E63"><rect width="32" height="32" fill="#E91E63" /></svg><br />
        <code>#E91E63</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadTropicalFruitsPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-tropical-fruits@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadTropicalFruitsPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadTropicalFruitsPalette` function.
