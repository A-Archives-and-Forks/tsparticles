...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/food/pineapple/images/sample.png)](https://particles.js.org/samples/palettes/pineapple)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#0B1007"><rect width="32" height="32" fill="#0B1007" /></svg><br />
        <code>#0B1007</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FBC02D"><rect width="32" height="32" fill="#FBC02D" /></svg><br />
        <code>#FBC02D</code>
      </td>
      <td align="center">
    ...
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFEE58"><rect width="32" height="32" fill="#FFEE58" /></svg><br />
        <code>#FFEE58</code>
      </td>
      <td align="center">
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#689F38"><rect width="32" height="32" fill="#689F38" /></svg><br />
        <code>#689F38</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#5D4037"><rect width="32" height="32" fill="#5D4037" /></svg><br />
        <code>#5D4037</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadPineapplePalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-pineapple@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadPineapplePalette(engine);
...
Checkout the documentation in the component library repository and call the `loadPineapplePalette` function.
