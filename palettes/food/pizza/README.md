...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/food/pizza/images/sample.png)](https://particles.js.org/samples/palettes/pizza)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#1B1207"><rect width="32" height="32" fill="#1B1207" /></svg><br />
        <code>#1B1207</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#F4D6A0"><rect width="32" height="32" fill="#F4D6A0" /></svg><br />
        <code>#F4D6A0</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#E0B06F"><rect width="32" height="32" fill="#E0B06F" /></svg><br />
        <code>#E0B06F</code>
      </td>
    </tr>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#C6863D"><rect width="32" height="32" fill="#C6863D" /></svg><br />
        <code>#C6863D</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#D84315"><rect width="32" height="32" fill="#D84315" /></svg><br />
        <code>#D84315</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#B71C1C"><rect width="32" height="32" fill="#B71C1C" /></svg><br />
        <code>#B71C1C</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFD54F"><rect width="32" height="32" fill="#FFD54F" /></svg><br />
        <code>#FFD54F</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#3A3A3A"><rect width="32" height="32" fill="#3A3A3A" /></svg><br />
        <code>#3A3A3A</code>
      </td>
    </tr>
    <tr>
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadPizzaPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-pizza@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
Checkout the documentation in the component library repository and call the `loadPizzaPalette` function.
