...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/food/sushi/images/sample.png)](https://particles.js.org/samples/palettes/sushi)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#0B1B16"><rect width="32" height="32" fill="#0B1B16" /></svg><br />
        <code>#0B1B16</code>
      </td>
      <td align="center">
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#F0F0F0"><rect width="32" height="32" fill="#F0F0F0" /></svg><br />
        <code>#F0F0F0</code>
      </td>
    </tr>
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#263238"><rect width="32" height="32" fill="#263238" /></svg><br />
        <code>#263238</code>
      </td>
    </tr>
    <tr>
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadSushiPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-sushi@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
Checkout the documentation in the component library repository and call the `loadSushiPalette` function.
