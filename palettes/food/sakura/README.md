...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/food/sakura/images/sample.png)](https://particles.js.org/samples/palettes/sakura)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#100810"><rect width="32" height="32" fill="#100810" /></svg><br />
        <code>#100810</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFF8F9"><rect width="32" height="32" fill="#FFF8F9" /></svg><br />
        <code>#FFF8F9</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFEBEE"><rect width="32" height="32" fill="#FFEBEE" /></svg><br />
        <code>#FFEBEE</code>
      </td>
    </tr>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFE0E6"><rect width="32" height="32" fill="#FFE0E6" /></svg><br />
        <code>#FFE0E6</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFCDD2"><rect width="32" height="32" fill="#FFCDD2" /></svg><br />
        <code>#FFCDD2</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadSakuraPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-sakura@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadSakuraPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadSakuraPalette` function.
