...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/food/macaron/images/sample.png)](https://particles.js.org/samples/palettes/macaron)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFF6F9"><rect width="32" height="32" fill="#FFF6F9" /></svg><br />
        <code>#FFF6F9</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#F8BBD0"><rect width="32" height="32" fill="#F8BBD0" /></svg><br />
        <code>#F8BBD0</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#F48FB1"><rect width="32" height="32" fill="#F48FB1" /></svg><br />
        <code>#F48FB1</code>
      </td>
    </tr>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#CE93D8"><rect width="32" height="32" fill="#CE93D8" /></svg><br />
        <code>#CE93D8</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#B39DDB"><rect width="32" height="32" fill="#B39DDB" /></svg><br />
        <code>#B39DDB</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#81D4FA"><rect width="32" height="32" fill="#81D4FA" /></svg><br />
        <code>#81D4FA</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadMacaronPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-macaron@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadMacaronPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadMacaronPalette` function.
