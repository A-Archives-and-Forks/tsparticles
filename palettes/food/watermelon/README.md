...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/food/watermelon/images/sample.png)](https://particles.js.org/samples/palettes/watermelon)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFF9F9"><rect width="32" height="32" fill="#FFF9F9" /></svg><br />
        <code>#FFF9F9</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFEDEE"><rect width="32" height="32" fill="#FFEDEE" /></svg><br />
        <code>#FFEDEE</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFD6D9"><rect width="32" height="32" fill="#FFD6D9" /></svg><br />
        <code>#FFD6D9</code>
      </td>
    </tr>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FF6B6B"><rect width="32" height="32" fill="#FF6B6B" /></svg><br />
        <code>#FF6B6B</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FF2A2A"><rect width="32" height="32" fill="#FF2A2A" /></svg><br />
        <code>#FF2A2A</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#C62828"><rect width="32" height="32" fill="#C62828" /></svg><br />
        <code>#C62828</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#212121"><rect width="32" height="32" fill="#212121" /></svg><br />
        <code>#212121</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#66BB6A"><rect width="32" height="32" fill="#66BB6A" /></svg><br />
        <code>#66BB6A</code>
      </td>
    </tr>
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#2E7D32"><rect width="32" height="32" fill="#2E7D32" /></svg><br />
        <code>#2E7D32</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#1B5E20"><rect width="32" height="32" fill="#1B5E20" /></svg><br />
        <code>#1B5E20</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadWatermelonPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-watermelon@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadWatermelonPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadWatermelonPalette` function.
