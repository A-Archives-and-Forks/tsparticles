...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/food/grapes/images/sample.png)](https://particles.js.org/samples/palettes/grapes)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#070711"><rect width="32" height="32" fill="#070711" /></svg><br />
        <code>#070711</code>
      </td>
      <td align="center">
    ...
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#4A148C"><rect width="32" height="32" fill="#4A148C" /></svg><br />
        <code>#4A148C</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadGrapesPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-grapes@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadGrapesPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadGrapesPalette` function.
