...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/food/steak/images/sample.png)](https://particles.js.org/samples/palettes/steak)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#120A07"><rect width="32" height="32" fill="#120A07" /></svg><br />
        <code>#120A07</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#4E342E"><rect width="32" height="32" fill="#4E342E" /></svg><br />
        <code>#4E342E</code>
      </td>
      <td align="center">
    ...
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#8E240F"><rect width="32" height="32" fill="#8E240F" /></svg><br />
        <code>#8E240F</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#EF5350"><rect width="32" height="32" fill="#EF5350" /></svg><br />
        <code>#EF5350</code>
      </td>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#3E2723"><rect width="32" height="32" fill="#3E2723" /></svg><br />
        <code>#3E2723</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadSteakPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-steak@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
Checkout the documentation in the component library repository and call the `loadSteakPalette` function.
