...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/food/cherry/images/sample.png)](https://particles.js.org/samples/palettes/cherry)
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FDE0DC"><rect width="32" height="32" fill="#FDE0DC" /></svg><br />
        <code>#FDE0DC</code>
      </td>
      <td align="center">
    ...
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#D32F2F"><rect width="32" height="32" fill="#D32F2F" /></svg><br />
        <code>#D32F2F</code>
      </td>
      <td align="center">
      ...
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#880E4F"><rect width="32" height="32" fill="#880E4F" /></svg><br />
        <code>#880E4F</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadCherryPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-cherry@4/tsparticles.palette-coloredSmokeAmber.min.js"></script>
```
...
(async engine => {
  ...
  await loadCherryPalette(engine);
...
Checkout the documentation in the component library repository and call the `loadCherryPalette` function.
