...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/food/apple-red/images/sample.png)](https://particles.js.org/samples/palettes/apple-red)
...
<table>
  <tbody>
    ...
    <tr>
      <td align="center">
        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="#FFCC80"><rect width="32" height="32" fill="#FFCC80" /></svg><br />
        <code>#FFCC80</code>
      </td>
      <td align="center">
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadAppleRedPalette` before `tsParticles.load(...)`
