...
1. Instale el wrapper y las dependencias de Next.js.
2. Mantenga el renderizado solo del lado del cliente para los canvas de particulas.
3. Inicialice el engine una vez y renderice el componente.
